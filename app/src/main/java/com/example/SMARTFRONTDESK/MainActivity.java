...
package com.example.SMARTFRONTDESK;
...
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationCardFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistartFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationCardListFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationCardOkFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationFolioFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationFolioOkFragment;
import com.example.SMARTFRONTDESK.FRAGMENT.RegistrationSettingFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //폴더 없을시 폴더 생성
        //db 경로
        dbPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS)+ File.separator+"DataBase";
        dbName = "REGICARD.db";
        ...
        try {
            ...
            while (c.moveToNext()) {
                ...
                Log.e("TAG", c.getString(3));
                Log.e("TAG", c.getString(4));
                Log.e("TAG", c.getString(5));
                Log.e("TAG", c.getString(6));
                Log.e("TAG", c.getString(7));
            }
